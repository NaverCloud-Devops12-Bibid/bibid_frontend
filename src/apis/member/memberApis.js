...
export const join = createAsyncThunk('members/join',
...
export const login = createAsyncThunk('members/login',
...
export const logout = createAsyncThunk('members/logout',
...
export const findMember = createAsyncThunk('members/mailSend',
...
export const verificationCodeCheck = createAsyncThunk('members/mailCheck',
...
export const findIdByEmail = createAsyncThunk('members/findByEmail',
...
export const modifyPasswd = createAsyncThunk('members/modifyPasswd',

    async (formData, thunkApi) => {

        try {
            const response = await axios.post(`${process.env.REACT_APP_BACK_SERVER}/members/modifyPasswd`, null, {
                params: {
...
export const kakaoJwtToken = createAsyncThunk('auth/kakaoJwtToken',
...
export const naverJwtToken = createAsyncThunk('auth/naverJwtToken',
...
export const googleJwtToken = createAsyncThunk('auth/googleJwtToken',
...
export const checkLogin = createAsyncThunk('auth/checkLogin',
...
export const uploadProfileImage = createAsyncThunk('members/uploadProfileImage',
...
export const chargeAccount = createAsyncThunk('account/chargeAccount',
...
export const exchangeAccount = createAsyncThunk('account/exchangeAccount',
...
export const buyAuction = createAsyncThunk('account/buyAuction',
...
export const sellAuction = createAsyncThunk('account/sellAuction',
...
export const fetchMember = createAsyncThunk('member/fetchMember',
